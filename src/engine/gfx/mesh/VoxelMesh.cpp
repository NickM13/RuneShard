...
Vector4<GLfloat> getAO(Vector3<Uint16> p_pos, Voxel*** p_voxels, Uint8 p_side)
{
	...
	case 0: // North
		...
		ao00 = ao00 - ((p_voxels[p_pos.x][p_pos.y - 1][p_pos.z - 1].interactionType == 0) + (p_voxels[p_pos.x][p_pos.y][p_pos.z - 1].interactionType == 0) + (p_voxels[p_pos.x][p_pos.y - 1][p_pos.z].interactionType == 0)) / 8.f;
		ao10 = ao10 - ((p_voxels[p_pos.x][p_pos.y + 1][p_pos.z - 1].interactionType == 0) + (p_voxels[p_pos.x][p_pos.y][p_pos.z - 1].interactionType == 0) + (p_voxels[p_pos.x][p_pos.y + 1][p_pos.z].interactionType == 0)) / 8.f;
		ao11 = ao11 - ((p_voxels[p_pos.x][p_pos.y + 1][p_pos.z + 1].interactionType == 0) + (p_voxels[p_pos.x][p_pos.y][p_pos.z + 1].interactionType == 0) + (p_voxels[p_pos.x][p_pos.y + 1][p_pos.z].interactionType == 0)) / 8.f;
		ao01 = ao01 - ((p_voxels[p_pos.x][p_pos.y - 1][p_pos.z + 1].interactionType == 0) + (p_voxels[p_pos.x][p_pos.y][p_pos.z + 1].interactionType == 0) + (p_voxels[p_pos.x][p_pos.y - 1][p_pos.z].interactionType == 0)) / 8.f;
		break;
	case 1: // South
		ao00 = GLfloat(p_voxels[p_pos.x + 1][p_pos.y - 1][p_pos.z].interactionType != 0) +		(p_voxels[p_pos.x + 1][p_pos.y - 1][p_pos.z - 1].interactionType != 0) + (p_voxels[p_pos.x + 1][p_pos.y][p_pos.z - 1].interactionType != 0) +	(p_voxels[p_pos.x + 1][p_pos.y][p_pos.z].interactionType != 0);
		ao10 = GLfloat(p_voxels[p_pos.x + 1][p_pos.y][p_pos.z].interactionType != 0) +			(p_voxels[p_pos.x + 1][p_pos.y][p_pos.z - 1].interactionType != 0) +	(p_voxels[p_pos.x + 1][p_pos.y + 1][p_pos.z - 1].interactionType != 0) + (p_voxels[p_pos.x + 1][p_pos.y + 1][p_pos.z].interactionType != 0);
	...
	case 2: // West
		...
		ao00 = ao00 - ((p_voxels[p_pos.x - 1][p_pos.y - 1][p_pos.z].interactionType == 0) + (p_voxels[p_pos.x][p_pos.y - 1][p_pos.z].interactionType == 0) + (p_voxels[p_pos.x - 1][p_pos.y][p_pos.z].interactionType == 0)) / 8.f;
		ao10 = ao10 - ((p_voxels[p_pos.x + 1][p_pos.y - 1][p_pos.z].interactionType == 0) + (p_voxels[p_pos.x][p_pos.y - 1][p_pos.z].interactionType == 0) + (p_voxels[p_pos.x + 1][p_pos.y][p_pos.z].interactionType == 0)) / 8.f;
		ao11 = ao11 - ((p_voxels[p_pos.x + 1][p_pos.y + 1][p_pos.z].interactionType == 0) + (p_voxels[p_pos.x][p_pos.y + 1][p_pos.z].interactionType == 0) + (p_voxels[p_pos.x + 1][p_pos.y][p_pos.z].interactionType == 0)) / 8.f;
		ao01 = ao01 - ((p_voxels[p_pos.x - 1][p_pos.y + 1][p_pos.z].interactionType == 0) + (p_voxels[p_pos.x][p_pos.y + 1][p_pos.z].interactionType == 0) + (p_voxels[p_pos.x - 1][p_pos.y][p_pos.z].interactionType == 0)) / 8.f;
		break;
	case 3: // East
		ao00 = GLfloat(p_voxels[p_pos.x - 1][p_pos.y][p_pos.z - 1].interactionType != 0) +		(p_voxels[p_pos.x - 1][p_pos.y - 1][p_pos.z - 1].interactionType != 0) + (p_voxels[p_pos.x][p_pos.y - 1][p_pos.z - 1].interactionType != 0) +	(p_voxels[p_pos.x][p_pos.y][p_pos.z - 1].interactionType != 0);
		ao10 = GLfloat(p_voxels[p_pos.x][p_pos.y][p_pos.z - 1].interactionType != 0) +			(p_voxels[p_pos.x][p_pos.y - 1][p_pos.z - 1].interactionType != 0) +	(p_voxels[p_pos.x + 1][p_pos.y - 1][p_pos.z - 1].interactionType != 0) + (p_voxels[p_pos.x + 1][p_pos.y][p_pos.z - 1].interactionType != 0);
	...
	case 4: // Top
		...
		ao00 = ao00 - ((p_voxels[p_pos.x - 1][p_pos.y][p_pos.z - 1].interactionType == 0) + (p_voxels[p_pos.x][p_pos.y][p_pos.z - 1].interactionType == 0) + (p_voxels[p_pos.x - 1][p_pos.y][p_pos.z].interactionType == 0)) / 8.f;
		ao10 = ao10 - ((p_voxels[p_pos.x + 1][p_pos.y][p_pos.z - 1].interactionType == 0) + (p_voxels[p_pos.x][p_pos.y][p_pos.z - 1].interactionType == 0) + (p_voxels[p_pos.x + 1][p_pos.y][p_pos.z].interactionType == 0)) / 8.f;
		ao11 = ao11 - ((p_voxels[p_pos.x + 1][p_pos.y][p_pos.z + 1].interactionType == 0) + (p_voxels[p_pos.x][p_pos.y][p_pos.z + 1].interactionType == 0) + (p_voxels[p_pos.x + 1][p_pos.y][p_pos.z].interactionType == 0)) / 8.f;
		ao01 = ao01 - ((p_voxels[p_pos.x - 1][p_pos.y][p_pos.z + 1].interactionType == 0) + (p_voxels[p_pos.x][p_pos.y][p_pos.z + 1].interactionType == 0) + (p_voxels[p_pos.x - 1][p_pos.y][p_pos.z].interactionType == 0)) / 8.f;
		break;
	case 5: // Bottom
		ao00 = GLfloat(p_voxels[p_pos.x - 1][p_pos.y - 1][p_pos.z].interactionType != 0) +		(p_voxels[p_pos.x - 1][p_pos.y - 1][p_pos.z - 1].interactionType != 0) + (p_voxels[p_pos.x][p_pos.y - 1][p_pos.z - 1].interactionType != 0) +	(p_voxels[p_pos.x][p_pos.y - 1][p_pos.z].interactionType != 0);
		ao10 = GLfloat(p_voxels[p_pos.x][p_pos.y - 1][p_pos.z].interactionType != 0) +			(p_voxels[p_pos.x][p_pos.y - 1][p_pos.z - 1].interactionType != 0) +	(p_voxels[p_pos.x + 1][p_pos.y - 1][p_pos.z - 1].interactionType != 0) + (p_voxels[p_pos.x + 1][p_pos.y - 1][p_pos.z].interactionType != 0);
