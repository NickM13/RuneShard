...
void Container::input()
{
	...
	Sint8* keyStates = Globals::getInstance().m_keyStates;
	Sint8* mouseStates = Globals::getInstance().m_mouseStates;
	Vector2<Sint32> mousePos = Globals::getInstance().m_guiMousePos;
