...
CTileSet::CTileSet(std::string p_compName, std::string p_title, Vector2<Sint32> p_pos, Vector2<Sint32> p_size, Uint16 p_tileSize, Texture p_tileSheet, Sint8 p_colorTheme)
{
	...
	m_transparentTex = MTexture::getInstance().getUnit(LTexture::loadImage("gui\\Transparent.png"));
	m_selectTex = MTexture::getInstance().getUnit(LTexture::loadImage("gui\\TileSelect.png"));
